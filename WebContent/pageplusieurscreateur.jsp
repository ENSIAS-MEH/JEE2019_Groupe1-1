...
<html lang="en">
  ...
  <body>
   ...
   <c:forEach var="i" begin="0" end="${listUsers.size() - 1}" step="1">
        ...
        <div class="product-item">
          <div class="product-item-title d-flex">
            <div class="bg-faded p-5 d-flex ml-auto rounded">
              <h2 class="section-heading mb-0">
                ...
                <span class="section-heading-lower">${listUsers.get(i).getNom()   }</span>
              </h2>
            </div>
          </div>
          ...
          <div class="product-item-description d-flex mr-auto">
            <div class="bg-faded p-5 rounded">
              <p class="mb-0">${listUsers.get(i).getAbout_me() }</p>
              <div class="intro-button mx-auto">
              
              	<form action="myservlet" method="get">
		<button>TEst ${i }</button>
		<input type="hidden" name ="add" value="${ i+1 }">
	     </form>
